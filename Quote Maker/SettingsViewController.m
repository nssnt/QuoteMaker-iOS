...
- (void)viewDidLoad {
    self.listValues = [NSMutableArray arrayWithObjects: @"Cornerstone", @"BlendaScript", @"BacktoBlack-Regular", @"Alcubierre", @"BadheadTypeface", @"GrandHotel-Regular", @"Langdon", nil];
